        ...
        <div className="row g-4">
          <div className="col-lg-4 col-md-6">
            ...
            <div className="social-links mb-4">
              ...
              >
                <img src="/images/aboutHe/logoFaceBook.png" alt="Facebook" className="social-img" />
              </a>
                ...
                rel="noopener noreferrer"
              >
                <img src="/images/aboutHe/InstagramIcon.png" alt="Instagram" className="social-img" />
              </a>
                ...
                rel="noopener noreferrer"
              >
                <img src="/images/aboutHe/linkedin.png" alt="LinkedIn" className="social-img" />
              </a>
            </div>
          </div>
          ...
          <div className="col-lg-2 col-md-6">
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="https://www.amazon.es/stephen-king-merchandising/s?k=stephen+king+merchandising" target="_blank" rel="noopener noreferrer">
                  Productos
                </a>
              </li>
            </ul>
        ...
        <div className="container">
          <div className="row py-3">
            ...
            <div className="col-md-6 text-center text-md-end">
              <img src="/images/aboutHe/logoStephenKingSinBordes.png" alt="Logo" className="social-img" />
            </div>
          </div>
        </div>
      </div>
